...
#include <commdlg.h>	// OPENFILE 구조체를 이용하기 위한 해더
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
	...
	wcex.lpszMenuName = MAKEINTRESOURCEW(IDC_WINAPIPRACTICE);	// 임의로 만든 메뉴 연결
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	TCHAR filter[] = _T("Every File(*.*) \0*.*\0Test File\0*.txt;*.doc\0");
	switch (message)
	{
	case WM_CREATE:
	{
	...
	case WM_COMMAND:
	{
		...
		case ID_BOUNCE:
		{
			MessageBox(hWnd, _T("bounce"), _T("OKOK"), MB_OKCANCEL); // IDOK : 확인,취소 // MB_OK : 확인 // MB_CANCEL : 취소

		}	break;
		case ID_FILEOPENTEST:
		{
